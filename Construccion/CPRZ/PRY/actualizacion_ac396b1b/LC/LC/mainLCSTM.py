...
def main() -> int:
    ...
    # ── FASE 0: IA LOCAL pre-sesion (descarga + refactor en rama construccion) ──
    # Antes de hablar con Lucia: descarga modelos ligeros a modelosIAlocal/,
    # refactoriza LC/ -> construccion/ con barra de progreso que indica
    # cuando la version de sesion esta disponible.
    try:
