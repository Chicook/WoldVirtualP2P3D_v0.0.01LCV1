"""
RF_SL7_4.py - Control de Calidad con Transformers
========================================
"""
...
class QualityController(NeuronaMemoriaBase):
    def __init__(self, input_size: int = 4, output_size: int = 8, nombre: str = "QualityController"):
...
def create_quality_controller(input_size: int = 4, output_size: int = 8) -> QualityController:
    return QualityController(input_size=input_size, output_size=output_size)


if __name__ == "__main__":
    logger.info("RF_SL7_4.py cargado exitosamente")
