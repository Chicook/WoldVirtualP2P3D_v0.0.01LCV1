"""
_p2 - parte 1/1 (version de sesion LucIA).
Parte del subsistema LucIA (OrquestadorSistemaLucIA).
"""
from __future__ import annotations

"""
mainLCSTM - parte 2/4 (version de sesion LucIA).
El orquestador Maestro concretó la implementación de lenguajes y componentes necesarios para un sistema BKSVCB, SNSBSTNPRB, IAFREE, STYLOS y
"""
from __future__ import annotations
