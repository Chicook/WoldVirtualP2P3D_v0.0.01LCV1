"""
mainLCSTM - parte 1/4 (version de sesion LucIA).
Este código está configurando el entorno de entorno para ejecutar un script Python. Primero, se define un entorno llamado `CURRENT_FILE` que
"""
